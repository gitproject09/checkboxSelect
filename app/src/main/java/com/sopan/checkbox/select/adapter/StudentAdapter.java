package com.sopan.checkbox.select.adapter;
...
/**
 * Created by Sopan on 24-02-2018.
 */
            ...
            holder.recycler_checkbox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    if (isChecked) {
                        ...
                        Toast.makeText(context, "Checked : " + studentList.get(position).getUserName(), Toast.LENGTH_LONG).show();
                    } else {
                        studentList.get(position).setSelected(false);
                        Toast.makeText(context, "Unchecked : " + studentList.get(position).getUserName(), Toast.LENGTH_LONG).show();
                    }
                }
            });
        }
